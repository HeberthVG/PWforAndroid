...
bool PanzerWars::init()
{
    ...
    auto label = Label::createWithTTF("Panzer Wars", "fonts/Marker Felt.ttf", 48);
...
//    auto mbVs = MenuItemFont::create("Modo vs.", CC_CALLBACK_1(PanzerWars::ModoVsCallBack, this));
    ...
    auto mbArcade = MenuItemFont::create("Jugar", CC_CALLBACK_1(PanzerWars::ModoArcadeCallBack, this));
    //mbArcade->setFontSize(48);
    // create third menu item
    auto mbCreditos = MenuItemFont::create("Créditos", CC_CALLBACK_1(PanzerWars::CreditosCallBack,this));
    //mbCreditos->setFontSize(36);
    // now create a menu with menu items.
    auto menuCenter = Menu::create(mbArcade,mbCreditos, NULL);
